class Buyer < ActiveHash::Base
  self.data = [
    ...
    { id: 7, name: 'BOOK-OFF', category_id: [3, 4, 5, 7, 8, 9, 10, 11, 12, 16], procedure_id: [1, 2, 3],
    ...
    { id: 15, name: '福ちゃん', category_id: 16, procedure_id: [1, 3],
      url: 'https://fuku-chan.jp/kosen4/?page=la&item=kosen&caf_session_id=xuidx9004c8f3a7xb1f&caf_ad_id=418&cid=so-202406114e89c2f427875eee50b59ebdc4a8df60&utm_term' },
    { id: 16, name: 'THE GOLD', category_id: [3, 5, 6, 7, 12, 13, 14, 16], procedure_id: [1, 2, 3],
      url: 'https://www.the-gold.jp/feature/kimono/l4/?utm_source=&caf_session_id&caf_ad_id&caf_session_id=xuidx900fa75a48xaff&caf_ad_id=409&hc_uus=45c36c6ef927c40ed7fa24b2b8bd7aa0&link_code_ak=XZ7LU.1.NBTSO&referer=' },
