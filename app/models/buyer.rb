class Buyer < ActiveHash::Base
  self.data = [
    ...
    { id: 8, name: 'トイズキング', category_id: 8,
    ...
    { id: 9, name: 'A-SPORTS', category_id: 9,
    ...
    { id: 10, name: '楽器の買取屋さん', category_id: 10,
    ...
    { id: 11, name: 'まねきや', category_id: 11,
    ...
    { id: 13, name: 'さくらいカメラ', category_id: 13,
